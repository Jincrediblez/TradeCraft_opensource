#!/usr/bin/env python3
"""Build the illustrated TradeCraft user manual from English Markdown."""
...
SOURCE = ROOT / "TradeCraft_User_Manual.md"
OUTPUT = ROOT / "TradeCraft_User_Manual.pdf"
...
def cover_story() -> list:
    return [
        ...
        Spacer(1, 13 * mm),
        Table(
            [["LOCAL-FIRST", "ENGLISH FIRST", "RANDOMIZED DEMO"]],
