...
def build_story() -> list:
    story = [
        ...
        p("为什么交易者需要 TradeCraft", "h1"),
        p(
            "大多数交易者花了很多时间研究市场，却很少真正研究自己。一个月赚钱，不代表过程值得复制；"
            "一次亏损，也不一定说明决策是错的。真正困难的，通常不是找到更多信息，而是弄清楚自己的盈利"
            "究竟来自哪里，又为什么会犯同样的错误。",
            "body_large",
        ),
        box(
            "<b>TradeCraft 不荐股，不预测，不下单。</b>它只帮你把自己的交易看清楚：交易是否按计划执行？"
            "进出场质量如何？盈利和亏损真正来自哪里？有没有陷入过度交易？然后，一点一点打磨自己的交易体系。",
            YELLOW,
        ),
        Spacer(1, 5 * mm),
        pain_value(
        ...
        box(
            ...
            "工作区默认保存在本机；项目免费、开源。它的作用是让你的复盘更有证据，并把一个确认的问题"
            "变成下一阶段可检查的规则。",
            YELLOW,
        ),
        PageBreak(),
