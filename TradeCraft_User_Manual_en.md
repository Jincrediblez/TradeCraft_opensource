...
![English TradeCraft dashboard using randomized Demo data](docs/images/feature-guide-en/01-home.png)
...
![English Home dashboard](docs/images/feature-guide-en/01-home.png)
...
![English symbol-level Replay](docs/images/feature-guide-en/02-replay.png)
...
![English execution records](docs/images/feature-guide-en/03-trades.png)
...
![English Watchlist workspace](docs/images/feature-guide-en/04-watchlist.png)
...
![English Add symbols panel](docs/images/feature-guide-en/05-watchlist-add.png)
...
![English Performance page](docs/images/feature-guide-en/06-performance.png)
...
![English Performance YTD view](docs/images/feature-guide-en/07-performance-ytd.png)
...
![English trading-data rankings](docs/images/feature-guide-en/09-data-rank.png)
...
![English P&L heatmap](docs/images/feature-guide-en/10-data-pnl.png)
...
![English trading-notional heatmap](docs/images/feature-guide-en/11-data-amount.png)
...
![English trading-activity charts](docs/images/feature-guide-en/12-data-activity.png)
...
![English Nasdaq daily heatmap](docs/images/feature-guide-en/13-market-nasdaq.png)

### 7.2 S&P 500 daily heatmap

![English S&P 500 daily heatmap](docs/images/feature-guide-en/14-market-sp500.png)

### 7.3 Nasdaq YTD heatmap

![English Nasdaq YTD heatmap](docs/images/feature-guide-en/15-market-nasdaq-ytd.png)

### 7.4 S&P 500 YTD heatmap

![English S&P 500 YTD heatmap](docs/images/feature-guide-en/16-market-sp500-ytd.png)

### 7.5 Finviz map

Finviz opens in a separate browser tab. Use it as an additional external market-map view.

![English Finviz S&P 500 map](docs/images/feature-guide-en/17-market-finviz.png)
...
![English Audit overview](docs/images/feature-guide-en/18-audit-overview.png)
...
![English return attribution](docs/images/feature-guide-en/19-audit-outcome.png)
...
![English process-quality view](docs/images/feature-guide-en/20-audit-process.png)
...
![English behavior comparison](docs/images/feature-guide-en/21-audit-behavior.png)
...
![English trade evidence](docs/images/feature-guide-en/22-audit-evidence.png)
...
![English improvement log](docs/images/feature-guide-en/23-audit-improvement.png)
...
![English Demo AI summary](docs/images/feature-guide-en/24-audit-ai.png)
...
![English Settings page](docs/images/feature-guide-en/08-settings.png)
